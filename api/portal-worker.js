  ...
  const subsContent = \`<div class="card" style="margin-top:20px">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px" id="subsGrid">
      ...
      <div style="padding:20px;background:#FDF9F3;border:1px solid #D4C5A9;border-radius:10px;text-align:left">
        ...
        <select id="wlColor" style="width:100%;padding:6px 8px;border:1px solid #D4C5A9;border-radius:4px;font-size:.82rem;margin-bottom:6px"><option value="">Color / Pattern (any)</option><optgroup label="Solid Colors"><option value="black">Black</option><option value="white">White</option><option value="grey">Grey</option><option value="chocolate">Chocolate</option><option value="cinnamon">Cinnamon</option><option value="cream">Cream</option><option value="red">Red/Orange</option><option value="lavender">Lavender</option></optgroup><optgroup label="Patterns"><option value="striped">Striped/Tabby</option><option value="spotted">Spotted</option><option value="tuxedo">Tuxedo</option><option value="boots">Boots/Mittens</option><option value="bicolor">Bicolor</option><option value="colorpoint">Siamese Points</option><option value="tortie">Tortoiseshell</option><option value="smoke">Smoke</option></optgroup><option value="no_preference">No Preference</option></select>
